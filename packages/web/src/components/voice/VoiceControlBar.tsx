...
export function VoiceControlBar() {
  ...
  const containerClassName = voiceFullscreen
    ? `pointer-events-none absolute inset-x-0 bottom-0 z-20 h-24 flex items-end justify-center pb-6 transition-opacity duration-300 ease-out ${shareMenuOpen ? 'opacity-100' : 'opacity-0 hover:opacity-100 focus-within:opacity-100'}`
